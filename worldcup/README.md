...
to be able to use and update state.

- [ ] Name three lifecycle methods and their purposes.

componentDidMount 
is called as soon as the component is mounted and ready. This is a good place to initiate API calls, if you need to load data from a remote endpoint.
...
we want to make sure that other developers are able to work with our code and make modifications and  In order to make sure those modifications dont breaking our code we run tests.
