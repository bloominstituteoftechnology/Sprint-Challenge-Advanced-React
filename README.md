...
- [ ] Why would you use class component over function components (removing hooks from the question)?
      If the component needs more functionality, like keeping state, classes are better.

* [ ] Name three lifecycle methods and their purposes.
      componentDidMount - birth
      componentDidUpdate - growth/changes
...
- [ ] Why is it important to test our apps?
      It determines if your app is usable and will work for how any person will use it.
